        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">Unity University</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            {user ? (
              <Link to={getDashboardPath()} className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                Dashboard
              </Link>
            ) : (
              <>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {user ? (
                <Link
                  to={getDashboardPath()}
                  className="block px-3 py-2 text-base font-medium text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md"
                >
                  Dashboard
                </Link>
              ) : (
              ...
              {user && (
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <button
                    onClick={handleLogout}
                    className="block w-full text-left px-3 py-2 text-base font-medium text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md"
                  >
                    Logout
                  </button>
                </div>
