    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-slate-300 mt-2">View and manage your assignments</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredAssignments.length === 0 ? (
          <div className="card p-8 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2">No assignments found</h3>
            ...
            <div key={assignment.id} className="card p-6">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 dark:text-slate-300 mb-4">{assignment.description}</p>
                  ...
                  {assignment.materials && assignment.materials.length > 0 && (
                    <div className="mb-4">
                      <h4 className="text-sm font-medium text-gray-900 dark:text-slate-100 mb-2">Materials:</h4>
