    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">View your academic performance and download transcripts</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-primary-600 mb-2">{calculateSemesterGPA()}</div>
          <div className="text-sm text-gray-600">Semester GPA</div>
          <div className="text-xs text-gray-500 mt-1">{selectedSemester}</div>
        </div>
        <div className="card p-6 text-center">
          <div className="text-3xl font-bold text-green-600 mb-2">{calculateOverallGPA()}</div>
          ...
          <div key={index} className="card p-6">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600">{course.code} • {course.credits} credits • {course.instructor}</p>
              </div>
              <div className="text-right">
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getGradeColor(course.finalGrade)}`}>
                  {course.finalGrade}
                </div>
                <p className="text-sm text-gray-600 mt-1">GPA: {course.gpa}</p>
              </div>
            </div>
