...
const StudentProfile = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="card p-6 text-center">
            ...
            <p className="text-gray-600 dark:text-slate-300">{formData.studentId}</p>
            <p className="text-sm text-gray-500 dark:text-slate-400">{formData.program} • {formData.year}</p>
      ...
      <div className="card p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Academic Information</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Student ID</label>
            <p className="text-gray-900 dark:text-slate-100">{formData.studentId}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Program</label>
            <p className="text-gray-900 dark:text-slate-100">{formData.program}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Year</label>
            <p className="text-gray-900 dark:text-slate-100">{formData.year}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Current GPA</label>
            <p className="text-gray-900 dark:text-slate-100">{formData.gpa}</p>
          </div>
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Academic Advisor</label>
            <p className="text-gray-900 dark:text-slate-100">{formData.advisor}</p>
          </div>
        </div>
      </div>
