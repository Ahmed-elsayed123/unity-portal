  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-50">Exams & Tests</h1>
          <p className="text-gray-600 dark:text-slate-300 mt-2">Manage your examinations and online assessments</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="card p-4 text-center">
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{upcomingExams.length}</div>
          <div className="text-sm text-gray-600 dark:text-slate-300">Upcoming Exams</div>
        </div>
        <div className="card p-4 text-center">
          <div className="text-2xl font-bold text-green-600 dark:text-green-400">{completedExams.length}</div>
          <div className="text-sm text-gray-600 dark:text-slate-300">Completed</div>
        </div>
        <div className="card p-4 text-center">
          <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{onlineTests.length}</div>
          <div className="text-sm text-gray-600 dark:text-slate-300">Online Tests</div>
        </div>
        <div className="card p-4 text-center">
      ...
      <div className="card">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">Upcoming Exams</h2>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {upcomingExams.map((exam) => (
              <div key={exam.id} className="border border-gray-200 dark:border-slate-600 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">{exam.title}</h3>
                    <p className="text-gray-600 dark:text-slate-300">{exam.course} • {exam.instructor}</p>
                  </div>
      ...
      <div className="card">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">Online Tests</h2>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {onlineTests.map((test) => (
              <div key={test.id} className="border border-gray-200 dark:border-slate-600 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">{test.title}</h3>
                    <p className="text-gray-600 dark:text-slate-300">{test.course} • {test.instructor}</p>
                  </div>
      ...
      <div className="card">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100">Completed Exams</h2>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {completedExams.map((exam) => (
              <div key={exam.id} className="border border-gray-200 dark:border-slate-600 rounded-lg p-4">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">{exam.title}</h3>
                    <p className="text-gray-600 dark:text-slate-300">{exam.course} • {exam.instructor}</p>
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">{exam.score}/{exam.totalMarks}</div>
                    <div className="text-sm text-gray-600 dark:text-slate-300">Grade: {exam.grade}</div>
                  </div>
                </div>
      ...
      <div className="card p-6 bg-yellow-50 dark:bg-yellow-900/30 border-yellow-200 dark:border-yellow-700">
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-semibold text-yellow-800 dark:text-yellow-300 mb-2">Exam Guidelines</h3>
