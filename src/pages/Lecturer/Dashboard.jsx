...
const LecturerDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-50">Lecturer Dashboard</h1>
        <p className="text-gray-600 dark:text-slate-300 mt-2">Welcome back! Here's your teaching overview.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50">My Courses</h2>
          ...
          <div className="space-y-4">
            {courses.map((course) => (
              <div 
                ...
                className="border border-gray-200 dark:border-slate-600 rounded-lg p-4 hover:shadow-md transition-shadow bg-white dark:bg-slate-800 cursor-pointer"
              >
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-slate-100">{course.name}</h3>
                    <p className="text-sm text-gray-600 dark:text-slate-300">{course.code} • {course.students} students</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900 dark:text-slate-100">{course.averageGrade}%</p>
                    <p className="text-xs text-gray-600 dark:text-slate-300">Avg Grade</p>
                  </div>
                </div>
            ...
            {recentActivities.map((activity, index) => (
              <div key={index} className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-slate-300">{activity.course} • {activity.time}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50">Upcoming Tasks</h2>
            <Clock className="h-5 w-5 text-gray-400 dark:text-slate-400" />
          </div>
          <div className="space-y-3">
            {upcomingTasks.map((task, index) => (
              <div key={index} className="flex items-center justify-between p-3 border border-gray-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary-600 rounded-full"></div>
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-slate-100">{task.task}</p>
                    <p className="text-xs text-gray-600 dark:text-slate-300">{task.course}</p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-600 dark:text-slate-300 mt-1">{task.due}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="font-medium text-gray-900 dark:text-blue-100">Manage Courses</p>
              <p className="text-sm text-gray-600 dark:text-blue-200">View and edit courses</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="font-medium text-gray-900 dark:text-green-100">Grade Assignments</p>
              <p className="text-sm text-gray-600 dark:text-green-200">Review student work</p>
            </button>
            <button 
              onClick={() => navigate('/lecturer/attendance')}
              className="p-4 bg-yellow-50 dark:action-attendance rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-800/60 transition-all duration-200 text-left w-full border border-transparent dark:border-yellow-600/60 shadow-lg hover:shadow-xl"
            >
              <Users className="h-6 w-6 text-yellow-600 dark:text-yellow-100 mb-2" />
              <p className="font-medium text-gray-900 dark:text-yellow-100">Mark Attendance</p>
              <p className="text-sm text-gray-600 dark:text-yellow-200">Record student presence</p>
            </button>
            <button 
              onClick={() => navigate('/lecturer/students')}
              className="p-4 bg-purple-50 dark:action-messages rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800/60 transition-all duration-200 text-left w-full border border-transparent dark:border-purple-600/60 shadow-lg hover:shadow-xl"
            >
              <MessageSquare className="h-6 w-6 text-purple-600 dark:text-purple-100 mb-2" />
              <p className="font-medium text-gray-900 dark:text-purple-100">Student List</p>
              <p className="text-sm text-gray-600 dark:text-purple-200">View all students</p>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="card p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-50 mb-4">Performance Overview</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">92%</div>
            <div className="text-sm text-gray-600 dark:text-slate-300">Average Student Satisfaction</div>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-slate-300">Average Class Attendance</div>
            <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-slate-300">Assignment Completion Rate</div>
            <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
