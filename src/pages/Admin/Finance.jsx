  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-50">Finance Management</h1>
          <p className="text-gray-600 dark:text-slate-300 mt-2">Manage financial operations and fee collection</p>
        </div>
